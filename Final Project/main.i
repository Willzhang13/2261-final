...
# 1 "lose.h" 1
# 22 "lose.h"
extern const unsigned short loseTiles[2160];
...
void goToStart() {
    ...
    DMANow(3, startTiles, &((charblock *)0x6000000)[0], 6144 / 2);
...
void goToIns() {
    stopSound();
    DMANow(3, insPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, insTiles, &((charblock *)0x6000000)[0], 7456 / 2);
    DMANow(3, insMap, &((screenblock *)0x6000000)[31], 2048 / 2);
    state = INS;
}
...
void goToGame() {
    DMANow(3, background0Pal, ((unsigned short *)0x5000000), 256);
    DMANow(3, UITiles, &((charblock *)0x6000000)[0], 1728 / 2);
    DMANow(3, UIMap, &((screenblock *)0x6000000)[31], 2048 / 2);
...
void goToPause() {
    ...
    DMANow(3, pausedTiles, &((charblock *)0x6000000)[0], 2912 / 2);
    DMANow(3, pausedMap, &((screenblock *)0x6000000)[31], 2048 / 2);
}
...
void goToWin() {
    ...
    DMANow(3, winTiles, &((charblock *)0x6000000)[0], 4224 / 2);
...
void goToLose() {
    ...
    DMANow(3, loseTiles, &((charblock *)0x6000000)[0], 4320 / 2);
